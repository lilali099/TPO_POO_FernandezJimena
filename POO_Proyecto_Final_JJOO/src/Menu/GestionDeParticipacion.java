...
public class GestionDeParticipacion {
    ...
    public boolean registrarAtletaEnCompetencia() {
        ...
        System.out.println("Especialidad atleta: " + atleta.getEspecialidad());
        System.out.println("Disciplina competencia: " + competencia.getDisciplina().getNombre());
        if (atleta == null || competencia == null) {
            System.out.println("❌ Atleta o competencia inexistente.");
            return false;
        }

        if (!atleta.getEspecialidad().equalsIgnoreCase(
                competencia.getDisciplina().getNombre())) {

            System.out.println("❌ El atleta no cumple con la especialidad requerida.");
            return false;
        }
